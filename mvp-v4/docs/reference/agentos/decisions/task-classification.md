...
2. **Level 2+**: Launch `/pattern-searcher` subagent for pattern discovery
3. Use semantic search: "tasks like [requirement summary]"
4. Review similar patterns found (from subagent or direct search)
5. Match semantic patterns from search results
6. Document search terms and results in task plan header
7. Document subagent used (if Level 2+)
